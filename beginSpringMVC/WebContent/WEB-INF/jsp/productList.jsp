    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>	              
		            <label class="label-align">
		  				<input type="checkbox" name="brand" value="sony"><span>Sony</span>
		  			 </label>	             
	             </li>
	             <li>	              
		            <label class="label-align">
		  				<input type="checkbox" name="brand" value="dell"><span>Dell</span>
		  			 </label>	             
	             </li>
                <li>
                	<label class="label-align">
                    	<input type="checkbox" name="brand" value="lenovo"><span>Lenovo</span> 
                    </label> 	
                </li>
